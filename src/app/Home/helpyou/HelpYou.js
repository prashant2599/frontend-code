  ...
  return (
    <>
        ...
        <div className="midbox-inner  wiki-mk">
          <img src="/images/2023/02/logo.png" className="logo-med" alt="Brand Logo" />
                ...
                {contentItems.map((item) => ( 
                  ...
                  >
                    ...
                    {activeContent === item.id && ( // Render text and image only when activeContent matches item.id
                      <React.Fragment>
                        <p>{item.text}</p>
                        <img src={item.image} alt={`Content ${item.id}`} className='help-you-m' />
                      </React.Fragment>
                    )}
                  </div>
                ))}
