        ...
        <div className="midbox-inner  wiki-mk">
          <div className="treatment-findox">
            <div className="treatment-leftbox">
              <ul>
                <li>
                  <a target="_self" href="#transplant-nav1" className="active">
                    Overview
                  </a>
                </li>
                {info.head_brief && (
            ...
            <div className="treatment-midbox">
              ...
              <div className="treatmen-midnav" id="transplant-nav16">
                ...
                <p>
                  ...
                  of experience, we connect you to a wide network of India&pos;s
                  best doctors
                </p>
            ...
            <div className="treatment-rightbox">
              ...
              <div className="navbox">
                ...
                <Link href={`/doctor-list/${speciality[0].slug}/${info.slug}`}>
                  <h4>Doctors</h4>
                </Link>
