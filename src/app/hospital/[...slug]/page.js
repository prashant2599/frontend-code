            ...
            <div className="overall-rating">
              <div className="overall-rating-left">
                ...
                <div className="star-rating">
                  <div className="rating-nobox">{overallRating.toFixed(2)}</div>
                  {rating.length > 0 ? (
              ...
              <div className="overall-rating-right">
                ...
                <div className="reviews-top-box">
                  <p className="more">
                    In every aspect, this hospital exceeded my expectations. The
                    staffs genuine concern and warmth made me feel like more
                    than simply a patient. The doctors took the time to listen
                    and properly explain everything to me, which gave me
                    confidence in my treatment. Its more than a hospital; its a
                    place where healing is supported by compassion, and where
                    everyone genuinely cares about your health.
                  </p>
